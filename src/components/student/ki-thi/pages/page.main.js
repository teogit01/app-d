...
function PageMain(props) {
    ...
    useEffect(() => {
        if (sinhvien) {
            const arrKithi = []
            if (sinhvien.nhoms && sinhvien.nhoms.length > 0) {
                sinhvien.nhoms.map(nhom => {
                    if (nhom.kithis && nhom.kithis.length > 0) {
    ...
    //     if (data.data.nhoms && data.data.nhoms.length > 0) {
    ...
    console.log('kithiA', kithiActived)
    return (
        <div className='page-ki-thi'>
            <div className='content-page'>
                <div className='left'>
                    ...
                    <FontAwesomeIcon className='ic-add ic-init2' icon="plus" /> */}
                    {
                        ...
                        kithis.map(kithi => {
                            if (kithi.trangthai)
                                return (
                                    <div className='kithis' key={kithi._id}
                                        onClick={() => changeKithiActived(kithi)}
                                    >
                                        <KiThi kithi={kithi} kithiActived={kithiActived}
                                        //remove={handleRemove} 
                                        />
                                    </div>
                                )
                ...
                <div className='right'>
                    {
                        (kithiActived && kithiActived.trangthai) && <KiThiCT
                            kithi={kithiActived}
